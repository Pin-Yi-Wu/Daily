            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (selectedCount > 0) {
                    ...
                    Intent intent = new Intent(
                            "com.example.mina.daily.EDIT_ITEM");

                    // 設定記事編號與記事物件
                    intent.putExtra("position", position);
                    intent.putExtra("com.example.mina.daily.Item", item);
    ...
    public void clickMenuItem(MenuItem item) {
        ...
        switch (itemId) {
            ...
            case R.id.add_item:
                ...
                Intent intent = new Intent("com.example.mina.daily.ADD_ITEM");

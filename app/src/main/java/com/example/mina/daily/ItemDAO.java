...
public class ItemDAO {
    ...
    public void sample() {
        ...
        Item item = new Item(0, new Date().getTime(), Colors.RED, "關於Diary的事情.", "Hi你是第一個使用者", "", "", 0, 0, 0);
        Item item2 = new Item(0, new Date().getTime(), Colors.BLUE, "一隻非常可愛的小狗狗!", "她的名字叫「麻尼」，是一隻非常漂亮\n的小狗。", "", "", 25.04719, 121.516981, 0);
        Item item3 = new Item(0, new Date().getTime(), Colors.GREEN, "第一次自己去旅行", "在城市發現許多特別的東西", "", "", 0, 0, 0);
